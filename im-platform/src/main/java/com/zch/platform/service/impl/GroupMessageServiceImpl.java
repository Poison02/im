...
import com.zch.common.constants.IMConstant;
...
import com.zch.platform.dto.GroupMessageDTO;
import com.zch.platform.entity.Group;
import com.zch.platform.entity.GroupMember;
import com.zch.platform.entity.GroupMessage;
...
import com.zch.platform.service.IGroupMessageService;
...
import com.zch.platform.util.SensitiveFilterUtil;
    ...
    public void pullOfflineMessage(Long minId) {
        ...
        messageGroupMap.forEach((groupId, groupMessages) -> {
            ...
            for(GroupMessage m:groupMessages){
                ...
                // 排除不需要接收的消息
                List<String> recvIds = CommaTextUtil.asList(m.getRecvIds());
